  ...
  fr: {
    ...
    moves: {
      ...
      items: [
        ...
        { frame: "03/03", tag: "Maîtrise", title: "Redirection", sub: "Pouvoir spécial : une redirection empêche l'adversaire de toucher le porteur du ballon." },
      ],
    },
    zones: {
      label: "Les zones",
  ...
  en: {
    ...
    moves: {
      ...
      items: [
        ...
        { frame: "03/03", tag: "Mastery", title: "Redirection", sub: "Special power: a redirection prevents the opponent from tagging the ball carrier." },
      ],
    },
    zones: {
      label: "The zones",
