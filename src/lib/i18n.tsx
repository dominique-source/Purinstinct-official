...
export const translations = {
  fr: {
    ...
    hero: {
      label: "Le mouvement",
      h1a: "Le sport le plus",
      h1b: "athlétique au monde",
      sub: "2 équipes. 5 minutes. Pur instinct. Un jeu révolutionnaire qui fusionne vitesse, habileté et intelligence de jeu.",
  ...
  en: {
    ...
    hero: {
      label: "The movement",
      h1a: "The world's most",
      h1b: "athletic sport",
      sub: "2 teams. 5 minutes. Pure instinct. A revolutionary game that fuses speed, skill, and game intelligence.",
      cta1: "Learn to play",
      cta2: "Host an event",
